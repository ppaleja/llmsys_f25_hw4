...
# [Assignment 1: CUDA Programming - CMU 11868 LLM Systems 2025 Fall Assignments](https://llmsystem.github.io/llmsystemhomework/assignment_1/)
...
The starting code base is provided in [llmsystem/llmsys\_f25\_hw1.git](https://github.com/llmsystem/llmsys_f25_hw1.git).
...
**Quick Start with Google Colab**: Download our [interactive template notebook](https://github.com/llmsystem/llmsys_f25_hw1/blob/main/llmsys_f25_hw1_template.ipynb) to get started immediately with Google Colab.
...
Create a directory for compiled cuda\_kernels.
...
![image title](ReadItLater%20Inbox/assets/Assignment%201%20CUDA%20Programming%20-%20CMU%2011868%20LLM%20Systems%202025%20Fall%20Assignments-ReHkCoU3cs.jpeg)
...
![Image title](ReadItLater%20Inbox/assets/Assignment%201%20CUDA%20Programming%20-%20CMU%2011868%20LLM%20Systems%202025%20Fall%20Assignments-i9cF8DgFlR.png)
...
![Image title](ReadItLater%20Inbox/assets/Assignment%201%20CUDA%20Programming%20-%20CMU%2011868%20LLM%20Systems%202025%20Fall%20Assignments-1KpA9XKX66.png)

Figure 3: Simple parallelization.

#### Hints - Shared Memory Tiling (Optional)

A more advanced way to accelerate matrix multiplication with shared memory tiling is illustrated in Figure 4. It is resource intensive to only utilize one thread to calculate one element of the output matrix. We can allocate a chunk of output elements for each block, and create threads inside the block to compute the results in parallel. Each block takes care of a chunk of `[S, S]` elements. Each thread inside the block calculates smaller parts of `[Si, L] × [L, Si]`, and accesses the shared memory across the block. We provide the pseudocode here for you. Refer to [[Programming Massively Parallel Processors - A Hands-on.pdf#page=131&offset=,,|Chapter 5.4 A Tiled Matrix Multiplication Kernel]] in [[Programming Massively Parallel Processors - A Hands-on.pdf|Programming Massively Parallel Processors, 4th Ed]] for more details.
...
![Image title](ReadItLater%20Inbox/assets/Assignment%201%20CUDA%20Programming%20-%20CMU%2011868%20LLM%20Systems%202025%20Fall%20Assignments-7e0gDJ9rs6.png)
...
1https://developer.download.nvidia.com/assets/cuda/files/reduction.pdf