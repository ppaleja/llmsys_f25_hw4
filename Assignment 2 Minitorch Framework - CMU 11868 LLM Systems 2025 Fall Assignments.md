...
# [Assignment 2: Minitorch Framework - CMU 11868 LLM Systems 2025 Fall Assignments](https://llmsystem.github.io/llmsystemhomework/assignment_2/)
...
The starting code base is provided in [llmsys\_f25\_hw2](https://github.com/llmsystem/llmsys_f25_hw2).
...
We also highly recommend setting up a virtual environment. The virtual environment lets you install packages that are only used for your assignments and do not impact the rest of the system. We recommend venv as it is lightweight and easy to use ([Tutorial](https://docs.python.org/3/tutorial/venv.html)).
...
1.  **My automatic differentiation implementation seems correct but tests are failing, what should I do?**
...
1.  **Training is taking too long, is this normal?**
